...
curl -X GET http://localhost:3000/api/veterinaria/ \
  -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..YbgPsJUgXHDb8XF_yP2hbeKSXou8PWWYzYcWERrWhLQ"
```
...
```bash
curl -X GET http://localhost:3000/api/veterinaria/699c89b62fab5960a5f75072 \
  -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..YbgPsJUgXHDb8XF_yP2hbeKSXou8PWWYzYcWERrWhLQ"
```
